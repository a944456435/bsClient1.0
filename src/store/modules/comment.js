...
export default {
  ...
  actions: {
    ...
    async findByRecommendId({ commit }, id) {
      let response = await get("/comment/findByRecommendId", { id });
    ...
    async findByCookbookId({ commit }, id) {
      let response = await get("/comment/findByCookbookId", { id });
    ...
    async saveComment({ commit }, payload) {
      let response = await post("/comment/saveOrUpdate", { payload });
      return response;
    },
  },
};
